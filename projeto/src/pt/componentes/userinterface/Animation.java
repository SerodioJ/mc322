...
public class Animation extends javax.swing.JFrame implements IAnimation{
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        //jTextArea2.setText("");
        //jTextArea2.append(this.falas[estado]);
        /*
        jLabel1.setIcon(null);
        if (this.personagem[estado].equalsIgnoreCase("doctor"))
            jLabel1.setIcon(new javax.swing.ImageIcon("/home/yukiharu/NetBeansProjects/UserInterface2/src/main/java/pt/userinterface/imagens/doctor.jpg"));
        else if (this.personagem[estado].equalsIgnoreCase("pacient"))
            jLabel1.setIcon(new javax.swing.ImageIcon("/home/yukiharu/NetBeansProjects/UserInterface2/src/main/java/pt/userinterface/imagens/pacient.jpg"));
        */
        else
    ...
    /*
    public void TimerExpired(java.awt.event.ActionEvent evento){
        novo += textinho.charAt(aux);
        aux++;
        jTextArea1.setText(novo);
    ...
    */
    ...
    private void writingOn(String fala, String nome){
        ...
        //nome = "<b>" + nome + "</b>";
        /*
        if(nome.equalsIgnoreCase("doctor") && docName != null)
            nome = "<b>" + docName + "</b>";
        else if (nome.equalsIgnoreCase("pacient") && pacName != null)
            nome = "<b>" + pacName + "</b>";
        */
        textinho = saida;
        novo = nome + "<br>";
    ...
    public void story(String[] falas, String[] personagem){
        ...
        */
        /*try {
            image2 = ImageIO.read(new File("./Untitled.png"));
            image = ImageIO.read(new File("./Webp.net-resizeimage.jpg"));
        } catch (IOException ex) {
            Logger.getLogger(Animation.class.getName()).log(Level.SEVERE, null, ex);
        }/*
        jLabel1.setIcon(new javax.swing.ImageIcon(image));
        jButton2.setIcon(new javax.swing.ImageIcon(image2));
        

        //jLabel1.setIcon(new javax.swing.ImageIcon("/home/yukiharu/NetBeansProjects/UserInterface2/src/main/java/pt/userinterface/imagens/Webp.net-resizeimage.jpg"));
        //jEditorPane1.setContentType("text/html");
        //jTextArea2.setText(falas[estado]);
        /*
        if(personagem[estado].equalsIgnoreCase("doctor"))
            jLabel1.setIcon(new javax.swing.ImageIcon("/home/yukiharu/NetBeansProjects/UserInterface2/src/main/java/pt/userinterface/imagens/doctor.jpg"));
        else
            jLabel1.setIcon(new javax.swing.ImageIcon("/home/yukiharu/NetBeansProjects/UserInterface2/src/main/java/pt/userinterface/imagens/pacient.jpg"));
        */
